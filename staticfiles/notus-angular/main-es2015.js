...
let LoginComponent = class LoginComponent {
    ...
    ngOnInit() { localStorage.getItem('token') ? this.loggedIn = true : this.loggedIn = false; }
    signIn() {
        const data = { username: this.username.value, password: this.password.value };
        axios__WEBPACK_IMPORTED_MODULE_5___default.a.post(_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API.host + _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API.endpoints.login, data).then(response => this.handleSignInResponse(response));
    }
...
module.exports = __webpack_require__(/*! /home/nunolemos/Downloads/notus-angular-main/src/main.ts */"zUnb");
...
const environment = {
    ...
    authStatus: () => localStorage.getItem('token') ? { isLoggedIn: true, key: localStorage.getItem('token') } : { isLoggedIn: false, key: null }
};
/*
...
let CardTableComponent = class CardTableComponent {
    ...
    set color(color) { this._color = color !== "light" && color !== "dark" ? "light" : color; }
    ngOnInit() { }
};
